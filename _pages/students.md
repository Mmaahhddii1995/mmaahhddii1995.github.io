...
- **Dheeray Kumar Suryakari**, *Packed Pre-Constructed Publicly Verifiable Secret Sharing and Applications*,  
  COSIC, Department of Electrical Engineering (ESAT), KU Leuven, Belgium, **2024–2025**

- **Louis Gregg**, *Improving Latency in Tor with Strategic Path Selection*,  
  COSIC, Department of Electrical Engineering (ESAT), KU Leuven, Belgium, **2024–2025**

- **Emre Tosun**, *On Practical Verifiable Timed Secret Sharing*,  
  COSIC, Department of Electrical Engineering (ESAT), KU Leuven, Belgium, **2025–2026**

- **Nicolas Sarabia Sauquillo**, *Mixnet Traffic Analysis from the Perspective of a Network Adversary*,  
  COSIC, Department of Electrical Engineering (ESAT), KU Leuven, Belgium, **2025–2026**
